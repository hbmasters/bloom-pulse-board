    ...
    <div className={`fixed inset-0 z-[100] flex items-center justify-center transition-opacity duration-700 ${
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-8 text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-primary-foreground/70 font-medium">— GISTER —</p>
        </div>
        ...
        <div className="grid grid-cols-5 gap-4 mb-8">
          <div className="bg-primary-foreground/10 rounded-xl p-4 backdrop-blur-sm border border-primary-foreground/10">
            ...
            <div className="text-3xl font-mono font-black text-primary-foreground">{stats.totalProduced.toLocaleString("nl-NL")}</div>
            <div className="text-[10px] text-primary-foreground/50 uppercase tracking-wider mt-1">Stuks Totaal</div>
          </div>
          <div className="bg-primary-foreground/10 rounded-xl p-4 backdrop-blur-sm border border-primary-foreground/10">
            ...
            <div className="text-[10px] text-primary-foreground/50 uppercase tracking-wider mt-1">Gem. PCS/H</div>
          </div>
          <div className="bg-primary-foreground/10 rounded-xl p-4 backdrop-blur-sm border border-primary-foreground/10">
            <Trophy className="w-6 h-6 text-primary-foreground/60 mx-auto mb-2" />
            <div className="text-3xl font-mono font-black text-primary-foreground">{stats.peakHourPcsPerHour.toLocaleString("nl-NL")}</div>
            <div className="text-[10px] text-primary-foreground/50 uppercase tracking-wider mt-1">Beste Uur</div>
          </div>
          <div className="bg-primary-foreground/10 rounded-xl p-4 backdrop-blur-sm border border-primary-foreground/10">
            ...
            <div className="text-[10px] text-primary-foreground/50 uppercase tracking-wider mt-1">Gem. Personen</div>
          </div>
          <div className="bg-primary-foreground/10 rounded-xl p-4 backdrop-blur-sm border border-primary-foreground/10">
            ...
            <div className="text-[10px] text-primary-foreground/50 uppercase tracking-wider mt-1">vs Planning</div>
          </div>
        </div>

        {/* Best order */}
        <div className="bg-primary-foreground/8 rounded-xl px-6 py-3 inline-block mb-8 border border-primary-foreground/10">
          <span className="text-sm text-primary-foreground/50">📈 Beste order: </span>
          <span className="text-sm font-bold text-primary-foreground">{stats.bestOrder}</span>
          <span className="text-sm text-primary-foreground/50"> — {stats.bestOrderPcs} stuks</span>
        </div>
        ...
        <div className="bg-primary-foreground/10 rounded-xl px-8 py-5 border border-primary-foreground/15 backdrop-blur-sm">
          ...
          <p className="text-lg font-semibold text-primary-foreground leading-relaxed">
            "Gisteren +{stats.performanceVsPlanned - 100}% boven planning. Sterke lijn."
          </p>
          <p className="text-base text-primary-foreground/70 mt-1">
            "Vandaag nieuwe kansen. Bouw sterk tempo."
          </p>
        </div>
      </div>
    </div>
