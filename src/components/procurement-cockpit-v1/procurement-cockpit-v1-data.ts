...
export const procurementRows: ProcurementRow[] = [
  { id: "1", product: "Chrysant Ringa Yellow", stem_length: "70cm", product_family: "Chrysant", customers: ["Bloemenveiling NL", "Albert Heijn"], bouquet_products: [{ name: "HBM Charme XL", stem_length: "70cm" }, { name: "HBM Field L", stem_length: "65cm" }], buyer: "Jan de Vries", required_volume: 12000, available_stock: 3200, reserved_stock: 1800, free_stock: 1400, open_buy_need: 5600, historical_price: 0.075, offer_price: 0.072, advised_price: 0.074, preferred_supplier: "Van der Berg Flowers", supplier_quality: 97, supplier_reliability: 96, supplier_score: 95, external_quality: "A1", internal_quality: 96, variance_vs_calculated: -4.0, ai_advice: "buy_now", urgency: "medium", status: "current" },
  { id: "2", product: "Roos Red Naomi", stem_length: "50cm", product_family: "Roos", customers: ["Fleurop DE", "Bloemenveiling NL", "Albert Heijn"], bouquet_products: [{ name: "HBM De Luxe", stem_length: "50cm" }, { name: "HBM Elegance", stem_length: "50cm" }, { name: "HBM Lovely", stem_length: "45cm" }], buyer: "Pieter Bakker", required_volume: 18000, available_stock: 2100, reserved_stock: 2100, free_stock: 0, open_buy_need: 7900, historical_price: 0.125, offer_price: 0.118, advised_price: 0.122, preferred_supplier: "Bloem & Blad NL", supplier_quality: 99, supplier_reliability: 97, supplier_score: 98, external_quality: "A1", internal_quality: 98, variance_vs_calculated: -5.6, ai_advice: "buy_now", urgency: "high", status: "urgent" },
  { id: "3", product: "Tulp Strong Gold", stem_length: "40cm", product_family: "Tulp", customers: ["Albert Heijn", "Jumbo"], bouquet_products: [{ name: "HBM Trend", stem_length: "40cm" }, { name: "HBM Spring Bouquet", stem_length: "40cm" }], buyer: "Jan de Vries", required_volume: 9500, available_stock: 4800, reserved_stock: 2000, free_stock: 2800, open_buy_need: 1700, historical_price: 0.055, offer_price: 0.052, advised_price: 0.054, preferred_supplier: "Flora Holland Pool", supplier_quality: 93, supplier_reliability: 91, supplier_score: 88, external_quality: "A1", internal_quality: 91, variance_vs_calculated: -5.5, ai_advice: "use_stock", urgency: "low", status: "current" },
  { id: "4", product: "Gerbera Kimsey", stem_length: "55cm", product_family: "Gerbera", customers: ["ALDI NL"], bouquet_products: [{ name: "HBM Chique", stem_length: "55cm" }], buyer: "Kees van Dam", required_volume: 15000, available_stock: 1200, reserved_stock: 1200, free_stock: 0, open_buy_need: 7800, historical_price: 0.046, offer_price: 0.044, advised_price: 0.045, preferred_supplier: "Gerbera Kwekerij Jansen", supplier_quality: 91, supplier_reliability: 88, supplier_score: 88, external_quality: "A2", internal_quality: 87, variance_vs_calculated: -4.3, ai_advice: "buy_now", urgency: "high", status: "today" },
  { id: "5", product: "Lisianthus Rosita White", stem_length: "60cm", product_family: "Lisianthus", customers: ["Jumbo", "Albert Heijn"], bouquet_products: [{ name: "HBM Pastel", stem_length: "55cm" }, { name: "HBM Moederdag", stem_length: "60cm" }], buyer: "Pieter Bakker", required_volume: 6000, available_stock: 2400, reserved_stock: 800, free_stock: 1600, open_buy_need: 1600, historical_price: 0.095, offer_price: 0.091, advised_price: 0.093, preferred_supplier: "Bloem & Blad NL", supplier_quality: 99, supplier_reliability: 97, supplier_score: 98, external_quality: "A1", internal_quality: 95, variance_vs_calculated: -4.2, ai_advice: "wait", urgency: "low", status: "current" },
  { id: "6", product: "Alstroemeria Virginia", stem_length: "65cm", product_family: "Alstroemeria", customers: ["Lidl NL", "ALDI NL"], bouquet_products: [{ name: "HBM Field M", stem_length: "60cm" }, { name: "HBM Zomermix", stem_length: "65cm" }], buyer: "Kees van Dam", required_volume: 8000, available_stock: 900, reserved_stock: 900, free_stock: 0, open_buy_need: 4600, historical_price: 0.062, offer_price: 0.068, advised_price: 0.064, preferred_supplier: "Bloem & Blad NL", supplier_quality: 99, supplier_reliability: 97, supplier_score: 98, external_quality: "A1", internal_quality: 94, variance_vs_calculated: 9.7, ai_advice: "price_high", urgency: "high", status: "urgent" },
  { id: "7", product: "Zonnebloem Sunrich", stem_length: "80cm", product_family: "Zonnebloem", customers: ["Bloemenveiling NL"], bouquet_products: [{ name: "HBM Zonnebloem", stem_length: "80cm" }], buyer: "Jan de Vries", required_volume: 5000, available_stock: 3100, reserved_stock: 1000, free_stock: 2100, open_buy_need: 400, historical_price: 0.088, offer_price: 0.085, advised_price: 0.087, preferred_supplier: "Van der Berg Flowers", supplier_quality: 97, supplier_reliability: 96, supplier_score: 95, external_quality: "A1", internal_quality: 97, variance_vs_calculated: -3.4, ai_advice: "contract_ok", urgency: "low", status: "completed" },
  { id: "8", product: "Roos Avalanche+", stem_length: "60cm", product_family: "Roos", customers: ["Fleurop DE", "Bloemenveiling NL"], bouquet_products: [{ name: "HBM De Luxe", stem_length: "60cm" }, { name: "HBM Orchidee Mix", stem_length: "55cm" }], buyer: "Pieter Bakker", required_volume: 14000, available_stock: 1800, reserved_stock: 1800, free_stock: 0, open_buy_need: 5200, historical_price: 0.135, offer_price: 0.130, advised_price: 0.133, preferred_supplier: "Bloem & Blad NL", supplier_quality: 99, supplier_reliability: 97, supplier_score: 98, external_quality: "A1", internal_quality: 96, variance_vs_calculated: -3.7, ai_advice: "prefer_supplier", urgency: "medium", status: "current" },
  { id: "9", product: "Chrysant Baltica White", stem_length: "70cm", product_family: "Chrysant", customers: ["Albert Heijn"], bouquet_products: [{ name: "HBM Charme", stem_length: "70cm" }], buyer: "Jan de Vries", required_volume: 10000, available_stock: 5200, reserved_stock: 3000, free_stock: 2200, open_buy_need: 800, historical_price: 0.068, offer_price: 0.066, advised_price: 0.067, preferred_supplier: "Van der Berg Flowers", supplier_quality: 97, supplier_reliability: 96, supplier_score: 95, external_quality: "A1", internal_quality: 93, variance_vs_calculated: -2.9, ai_advice: "use_stock", urgency: "low", status: "completed" },
  { id: "10", product: "Lelie Stargazer", stem_length: "75cm", product_family: "Lelie", customers: ["Bloemenveiling NL", "Fleurop DE"], bouquet_products: [{ name: "HBM Premium", stem_length: "75cm" }, { name: "HBM Elegance", stem_length: "70cm" }], buyer: "Kees van Dam", required_volume: 4000, available_stock: 600, reserved_stock: 600, free_stock: 0, open_buy_need: 1900, historical_price: 0.185, offer_price: 0.178, advised_price: 0.182, preferred_supplier: "Rosalina BV", supplier_quality: 95, supplier_reliability: 93, supplier_score: 91, external_quality: "A1", internal_quality: 92, variance_vs_calculated: -3.8, ai_advice: "buy_now", urgency: "medium", status: "today" },
];
